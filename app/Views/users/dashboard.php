<?= $this->extend('users/layouts/dashboard_layout') ?>
            ...
            <div class="table-responsive">
                    ...
                    ?>
                        <tr>
                            ...
                            <td>
                                <a href="<?= base_url('dashboard/'.$world['world_id'].'/edit') ?>" class="btn btn-success mb-3">Edit</a>
                                <a href="<?= base_url('dashboard/'.$world['world_id'].'/delete') ?>" class="btn btn-danger mb-3">Delete</a>
                            </td>
                        </tr>
                    <?php
                        }
            ...
            <div class="modal fade" id="addWorldModal" tabindex="-1" role="dialog" aria-labelledby="addWorldModalTitle" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        ...
                        <form action="<?= base_url('dashboard/create') ?>" method="post" id="formAddWorld">
